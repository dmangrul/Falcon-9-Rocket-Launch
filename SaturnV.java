...
public class SaturnV extends Rocket {
	...
	public SaturnV(int middleX, int middleY, int aWidth, int aHeight, Color aColor, String words) {
...
//		Figures/Variables from NASA do NOT match the equations perfectly, so
//		I increased the time, saw when the rocket reaches its max height, and
//		used that for burnTime. (This was discussed with Mr. Cool)
		time = 213;
